...
Write an SQL query to fix the names so that only the first character is uppercase 
...
+---------+-------+
"""
select Users.user_id, concat(upper(left(name, 1)), lower(substr(name, 2))) as name
